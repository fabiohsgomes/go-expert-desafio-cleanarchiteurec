...
import (
	...
	"github.com/fabiohsgomes/go-expert-desafio-cleanarchiteurec/internal/infra/graph/model"
...
func (ec *executionContext) field_Mutation_createOrder_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNOrderInput2githubᚗcomᚋfabiohsgomesᚋgoᚑexpertᚑdesafioᚑcleanarchiteurecᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNOrder2ᚖgithubᚗcomᚋfabiohsgomesᚋgoᚑexpertᚑdesafioᚑcleanarchiteurecᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_listOrders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖgithubᚗcomᚋfabiohsgomesᚋgoᚑexpertᚑdesafioᚑcleanarchiteurecᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNOrder2githubᚗcomᚋfabiohsgomesᚋgoᚑexpertᚑdesafioᚑcleanarchiteurecᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v model.Order) graphql.Marshaler {
	return ec._Order(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋfabiohsgomesᚋgoᚑexpertᚑdesafioᚑcleanarchiteurecᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgithubᚗcomᚋfabiohsgomesᚋgoᚑexpertᚑdesafioᚑcleanarchiteurecᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋfabiohsgomesᚋgoᚑexpertᚑdesafioᚑcleanarchiteurecᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNOrderInput2githubᚗcomᚋfabiohsgomesᚋgoᚑexpertᚑdesafioᚑcleanarchiteurecᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v any) (model.OrderInput, error) {
