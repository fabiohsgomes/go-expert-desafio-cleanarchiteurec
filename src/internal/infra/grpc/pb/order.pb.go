...
func (x *ListOrderItem) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *ListOrderItem) GetTax() float32 {
	if x != nil {
		return x.Tax
	}
	return 0
...
func (x *ListOrderItem) GetFinalPrice() float32 {
	if x != nil {
		return x.FinalPrice
	}
	return 0
...
func (x *ListOrdersResponse) GetOrders() []*ListOrderItem {
	if x != nil {
		return x.Orders
	}
	return nil
...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\x11.pb.ListOrderItemR\x06orders2\x8b\x01\n" +
	"\fOrderService\x12>\n" +
...
var file_internal_infra_grpc_protofiles_order_proto_goTypes = []any{
	...
	(*ListOrderItem)(nil),       // 2: pb.ListOrderItem
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	2, // 0: pb.ListOrdersResponse.orders:type_name -> pb.ListOrderItem
